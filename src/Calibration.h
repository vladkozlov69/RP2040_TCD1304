...
static const uint16_t DEFAULT_CALIBRATION_BLUE_PIXEL = 2620;
static const uint16_t DEFAULT_CALIBRATION_GREEN_PIXEL = 1950;
static const uint16_t DEFAULT_CALIBRATION_RED_PIXEL = 1380;
